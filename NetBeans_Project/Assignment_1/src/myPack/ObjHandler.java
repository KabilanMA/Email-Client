...
public class ObjHandler {
    ...
    public static void deserialize(String mailDate) {
        ...
        JavaMail mail; // declaring a JavaMail mail obj to derserialize the objects
        ...
        try {
            ...
            for (int i = 1; i <= count; i++) {
                ...
                } catch (IOException | ClassNotFoundException innerIO) {
                }
            }
    ...
    public static ArrayList<JavaMail> deserialize() {
         ...
         */
        ArrayList<JavaMail> sendMails = new ArrayList<>();
